...
$right_logo           = cnv_option( 'right-logo' );
...
<header id="masthead"
        class="site-header site-header--two header-width <?php echo esc_attr( $header_classes ); ?>" <?php if ( $is_fixed && ! empty( $logo_contrast ) ) {
        ...
        <nav id="site-navigation" class="main-nav">
            <div class="container">
                <div class="site-header-logo-area">
					...
					<?php if ( ! empty( $right_logo['url'] ) ) : ?>
                        <div class="right-logo">
                            <img src="<?php echo esc_url( $right_logo['url'] ) ?>" alt="logo">
                        </div>
					<?php endif; ?>
            ...
            <div class="main-nav-container canvas-menu-wrapper" id="mega-menu-wrap">
                ...
                <div class="menu-wrapper-inner">
                    <div class="container">
                        <div class="menu-wrapper <?php echo $nav_btn ? 'nav-right-show' : ''; ?>">
