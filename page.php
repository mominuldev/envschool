...
$sidebar = CNV_Theme_Helper::render_sidebars('page');
    ...
    <div class="container">
        <div class="row <?php echo apply_filters( 'cnv_row_class', $row_class ); ?>">
            <div id='main-content' class="col-lg-<?php echo apply_filters('cnv_column_class', $column); ?>">
                <?php
				the_content(esc_html__( 'Read more!', 'cnvschool' ));
                wp_link_pages(array('before' => '<div class="page-links">' . esc_html__( 'Pages', 'cnvschool' ) . ': ', 'after' => '</div>'));
